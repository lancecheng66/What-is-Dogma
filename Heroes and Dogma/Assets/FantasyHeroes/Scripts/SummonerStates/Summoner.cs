...
public class Summoner : Character1
{

    private ISummonerState currentState;
    ...
    {
        Target = null;
        ChangeState(new SummonerPatrolState());
    }
    ...
    public void ChangeState(ISummonerState newState)
    {
    ...
    public void Move()
    {
        if (!Attack)
        {
            ...
            else if (currentState is SummonerPatrolState)
            {
                ChangeDirection();
            }
        }
